...
const SuccessPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center ">
      ...
      <span className="w-[250px] h-[48px] text-[#333333] text-center mb-[18px] md:text-[24px] md:h-auto md:w-[350px]">
      ...
      <div className="w-full md:bg-[#f2f2f2] ">
        <div className="h-[395px] bg-[#f2f2f2] pt-[30px]  w-full  md:h-[690px]">
          <div className="w-full px-[25px] h-[348px] mx-auto md:w-auto md:max-w-[850px] md:px-[25px] leading-24 md:leading-48 text-[14px] md:text-[24px] px-2">
