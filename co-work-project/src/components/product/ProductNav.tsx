    ...
    <div className="pl-5">
      <div className="h-[168px] py-5 flex ">
        ...
        <div className="flex flex-col w-[190px]">
          <span className=" h-5 text-[#999999] text-[14px] mb-1 cursor-pointer">
            {owner}
          </span>
          <span className="text-[14px] mb-[36px] h-[42px] line-clamp-2 overflow-hidden cursor-pointer">
            {title}
          </span>
          <div className="flex justify-between items-end">
            <div className="flex flex-col h-[30px]  w-[92px] justify-end ">
              <p className="line-through text-[12px] text-[#999999] ">{`NT$${prevPrice}`}</p>
              <p className="text-[16px] text-[#ff655d] flex items-en">{`NT$${currentPrice}`}</p>
            </div>
            <div className="flex ">
      ...
      <div className="w-[93%] h-[1px] border-[1px] border-[#ececec] "></div>
    </div>
  );
}
